...
public class P7 {
	public static void main(String[] args) {
		...
		Printer.printMatrix(rotate(twoByTwo));
		System.out.println("----");
		Printer.printMatrix(rotateInPlace(twoByTwo));
		...
		Printer.printMatrix(rotate(threeByThree));
		System.out.println("----");
		Printer.printMatrix(rotateInPlace(threeByThree));
